          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-gray-600">Optimized for big data - No limits</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">
                Reports V2 - Optimized for Big Data
              </h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  This page uses MongoDB aggregation pipelines to efficiently handle millions of responses.
                  No data limits - shows exact counts based on your filters. Search-first filters reduce initial load time.
                </p>
              </div>
            </div>
          </div>
