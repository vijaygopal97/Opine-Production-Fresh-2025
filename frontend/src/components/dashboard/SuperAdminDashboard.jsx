      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link to="/admin/manage-companies" className="p-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="flex justify-between items-center p-2 hover:bg-gray-50 rounded-lg">
                ...
                <span className="text-sm font-medium text-blue-600">★ {company.rating}</span>
              </div>
            ))}
          </div>
        </div>
