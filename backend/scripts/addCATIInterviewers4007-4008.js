...
const interviewersData = [
  {
    ...
    firstName: 'Surajit',
    lastName: 'Ghosh',
    email: 'gtumpa459@gmail.com',
    phone: '9000004007', // Generated phone number
    password: '9000004007', // Password same as phone
    ac: 'Saltora'
  },
  {
    memberId: '4008',
    firstName: 'Lakhi',
    lastName: 'kanta ghosh',
    email: 'Jibonbari819@gmail.com',
    phone: '9000004008', // Generated phone number
    password: '9000004008', // Password same as phone
    ac: 'Saltora'
  },
  {
    memberId: '4009',
    firstName: 'Lakshmi',
    lastName: 'roy',
    email: 'lakshmiroy974@gmai.com',
    phone: '9134452477',
    password: '9134452477', // Password same as phone
    ac: 'Chandrakona'
  }
];
...
const main = async () => {
  try {
    ...
    for (const interviewerData of interviewersData) {
      console.log(`\n📝 Processing: ${interviewerData.firstName} ${interviewerData.lastName} (${interviewerData.memberId})`);
    ...
    console.log('='.repeat(80));
    console.log('\n✅ All interviewers processed successfully!\n');
    console.log('📋 Summary:');
    console.log('='.repeat(80));
