/**
 * Script to add approved CAPI interviewer users with specific member IDs (4001-4006) and AC assignments
 * 
...
const interviewersData = [
  {
    memberId: '4001',
    name: 'surajit ghosh',
    phone: '9000004001', // Generated phone number
    email: 'surajitghosh000123@gmai.com', // Note: typo in original (gmai instead of gmail)
    location: 'Saltora'
  },
  {
    memberId: '4002',
  ...
  },
  {
    ...
    name: 'Surajit Ghosh',
    phone: '9000004006',
    email: 'surajitghosh2828@gmail.com',
    location: 'Chandrakona'
  }
];
...
const main = async () => {
  try {
    ...
    console.log(`🚀 Starting creation of CAPI interviewers (4001-4006)...\n`);
